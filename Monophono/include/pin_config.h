...
#define PIN_CONFIG_H    
//
// define HERE the version of the BOARD
#define version 25
//#define version 3
...
////				BOARD: V3
    ...
    #define W_MUX_C_PIN     13
    #define W_MUX_B_PIN     12
    #define W_MUX_A_PIN     11
    #define W_EN_PIN        10
    #define R_MUX_OUT_PIN   6
    #define R_MUX_A_PIN     7
    #define R_MUX_B_PIN     8
    #define R_MUX_C_PIN     9
    ...
    #define CK_IN_PIN 4
    #define ARP_MODE_PIN 14
    #define ARP_ON_PIN 15
    #define CK_AMT_PIN 16
    #define ARP_OCT_PIN 17
